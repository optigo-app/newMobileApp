        ...
        <div className='paddingTopMobileSet' style={{
            ...
            <div className='smilingDelivery'>
                <p className="SmiCartListTitle">
                    <IoArrowBack style={{ height: '25px', width: '25px', marginRight: '10px' }} onClick={() => navigation('/Payment')}/>Select delivery address
                </p>
                <div className='smilingOrderMain'>
                    <div className='smilingdeliverBox1'>
                        <div className='smilingDeliveyAddressMain' style={{ display: 'flex', flexWrap: 'wrap', marginBottom: '90px' }}>
                            {
                                addressData?.map((item, index) => (
                                    <div key={item.id} className='AddressMain' style={{ backgroundColor: item.isdefault === 1 && 'rgb(245 244 244)' }} onClick={() => handleDefaultSelection(item.id)}>
                                        ...
                                        <p className='addressData' style={{marginLeft: '5px'}}> , {item.state}</p>
                                        </div>
                                        <p className='addressData' style={{ marginBottom: item.isdefault === 1 && '35px' }}>Phone : {item.shippingmobile}</p>
                                        {item.isdefault === 1 &&<div style={{ position: 'absolute', bottom: '5px', width: '90%', display: 'flex', marginTop: '10px' }}>
